...
/** Cohesive light theme — warm page, floating white cards, rich gold accents. */
export const PaletteLight: AppPalette = {
  background: '#F8F6F1',
  backgroundDeep: '#F0EDE6',
  surface: '#FFFFFF',
  surfaceWarm: '#FFFFFF',
  gold: '#B8860B',
  goldLight: '#C9A227',
  ...
  iconCircleBg: '#F5EFE0',
  liturgical: '#6B2C2F',
  streakGradientStart: '#FFFFFF',
  streakGradientEnd: '#FAF6EE',
  sheet: '#FFFFFF',
  navGlass: 'rgba(255, 255, 255, 0.96)',
  statusBar: 'dark',
  shadowColor: '#282319',
};
