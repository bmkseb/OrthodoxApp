...
export const SavedTeachingRow = memo(function SavedTeachingRow({
  title,
  subtitle,
  onPress,
  onRemove,
  variant = 'list',
}: SavedTeachingRowProps) {
    ...
    <>
      <OrthodoxPressable
        ...
        <View style={[styles.thumb, styles.thumbPlaceholder]}>
          <Icon name="scroll" size={18} color={Palette.gold} />
        </View>
      ...
      <SavedReadOptionsSheet
        ...
        title={title}
        subtitle={subtitle}
        placeholderIcon="scroll"
        removeLabel="Remove Saved Teaching"
