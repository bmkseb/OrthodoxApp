...
type SavedReadOptionsSheetProps = {
  visible: boolean;
  title: string;
  subtitle?: string;
  thumbnailUrl?: string;
  placeholderIcon?: Extract<IconName, 'book' | 'bookmark' | 'scroll'>;
  removeLabel: string;
  onClose: () => void;
  onRemove: () => void;
};

export function SavedReadOptionsSheet({
  visible,
  title,
  subtitle,
  thumbnailUrl,
            ...
            <View style={styles.header}>
              {thumbnailUrl ? (
                ...
                <View style={[styles.thumb, styles.thumbPlaceholder]}>
                  <Icon name={placeholderIcon} size={20} color={Palette.gold} />
                </View>
              )}
