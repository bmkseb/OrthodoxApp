...
import { CALENDAR_RAIL } from '@/lib/calendar-visual';
  ...
  const card = (
    <View style={styles.card}>
      <View style={styles.header}>
        <LinearGradient
          colors={[panelTint ?? CALENDAR_RAIL.badgeActiveBg, ...CALENDAR_RAIL.cardGradient]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
        ...
        {statusLabel ? (
          <View
            style={[
              styles.badge,
              statusActive && styles.badgeActive,
              { borderColor: `${accentColor}66` },
            ]}>
            <Text style={[styles.badgeText, statusActive && { color: accentColor }]}>
              {statusLabel}
            </Text>
          </View>
        ) : null}
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    overflow: 'hidden',
    borderWidth: 1,
    borderColor: CALENDAR_RAIL.borderColor,
  ...
  iconWrap: {
    ...
    backgroundColor: CALENDAR_RAIL.iconBackdrop,
    marginLeft: Space.s4,
  },
  badge: {
    position: 'absolute',
    ...
    borderRadius: BorderRadius.sm,
    borderWidth: 1,
    backgroundColor: CALENDAR_RAIL.badgeBg,
  },
  badgeActive: {
    backgroundColor: CALENDAR_RAIL.badgeActiveBg,
  },
  badgeText: {
    fontSize: 9,
    fontWeight: '700',
